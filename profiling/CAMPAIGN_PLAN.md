...
| gfm-20260303-r01 | inference | IF-SU1 | steady_unannotated | Steady-state unannotated inference window pair with stability gate. | `hmaintask_combine.py` | `test` | `datasets/single-pretrain-v3` | `checkpoints/single-sft/best_checkpoint` | `-` | `-` | `-` | `-` | not started | queued after `FT-SU1` completion |
