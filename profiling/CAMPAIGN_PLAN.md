...
| gfm-20260303-r01 | campaign | RV-G1 | review_gate | Capture-complete + human-review approval gate. | `-` | `-` | `-` | `-` | `-` | `-` | `-` | `-` | waiting_human_review | capture rows complete (`capture_complete=true`); waiting for explicit human review outcome to set `done` |
