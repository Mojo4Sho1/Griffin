...
|---|---|---|---|---|
| Single-table pretraining dataset (staged toy) | `datasets/single-pretrain-v3` | missing | 2026-03-05 | Historical staged path used in earlier validation runs; currently absent in workspace and not required for active realistic-scale execution. |
