...
| Phase 4c: Baseline validation `nsys` capture (`inference`) | in progress | Gate: `>=2` successful short validation slices for combine test path; `IF-B1` complete and `IF-B2` pending. |
