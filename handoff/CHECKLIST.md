...
| Phase 5: Steady-state unannotated representativeness gate | in progress | Baseline validation gates are complete across all scenarios; next active row is `TR-SU1` steady-state train window pair. |
