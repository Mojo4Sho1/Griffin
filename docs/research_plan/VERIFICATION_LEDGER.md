...
| C-16 | Source code locations responsible for hotspot_1 launches are not yet established | Not yet measured | `docs/research_plan/STATUS.md` — documented as open blocker | `docs/research_plan/experiments/EXP01_SOURCE_LOCALIZATION.md` | This is the primary goal of EXP01A. | Execute EXP01A source localization |
| C-17 | Matrix shapes responsible for hotspot_1 launches are not yet measured | Not yet measured | `docs/research_plan/STATUS.md` — documented as open blocker | `docs/research_plan/experiments/EXP02_SHAPE_CENSUS.md` | Pending EXP01A completion and EXP01A decision gate. | Execute EXP02 shape census after EXP01A |
